...
const addButtonToSaveProfile = () => {

    const button = document.createElement('button');
    button.textContent = 'Save Profile Details';
    ...
    // find element with class pv-top-card__non-self-photo-wrapper 
    const element = document.getElementsByClassName('pv-top-card__non-self-photo-wrapper')[0]
    if (!element) return
